...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultado->num_rows > 0) {
        ...
        $sql = "INSERT INTO recepcion_producto (fecha_recep, Orden_pedido_id_orden, Orden_pedido_Empleado_id_empleado, Orden_pedido_Proveedor_id_proveedor) 
                VALUES ('$fechaRecepcion', '$idOrden', '$idEmpleado', '$idProveedor')";
